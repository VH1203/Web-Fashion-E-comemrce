        ...
        <div className="card">
          ...
          <div className="card-body">
            <form onSubmit={createIntake} className="vstack gap-2">
              ...
              <button disabled={!canSubmit || loading} className="btn btn-primary mt-2">
      ...
      <div className="col-12 col-lg-7">
        <div className="card">
          <div className="card-header d-flex justify-content-between align-items-center">
            <span>Hàng đợi trung tâm (status: intake)</span>
            <div className="d-flex gap-2">
              <input className="form-control form-control-sm" placeholder="ownerShopId" style={{width:130}}
                ...
                {tickets.map(t => (
                  <tr key={t._id}>
                    ...
                    <td className="text-end">
                      ...
                      <Link to={`/tickets/${t._id}`} className="btn btn-sm btn-outline-secondary ms-2">View</Link>
                    </td>
                  </tr>
                ))}
                {tickets.length===0 && (
                  <tr><td colSpan={6} className="text-center text-muted py-4">Không có ticket intake</td></tr>
                )}
              </tbody>
            </table>
          </div>
